...
$this->Cell(50);
//Título
$this->Cell(130,10,'Logs modificaciones baneos Gamer Chileno',1,0,'C');
//Salto de línea
$this->Ln(10);
...
$pdf=new PDF();
$title='Logs modificaciones baneos Gamer Chileno';
$pdf->SetTitle($title);
$pdf->SetAuthor('Pablo Riquelme');
$pdf->SetY(65);
$pdf->ImprimirArchivo(1,'Modificacion baneos','archivos/modificacion-baneos.txt');
$pdf->Output('modificacion baneos GCL.pdf','I');
?> 