...
$this->Cell(50);
//Título
$this->Cell(90,10,'Logs Baneos Gamer Chileno',1,0,'C');
//Salto de línea
$this->Ln(10);
}
//Pie de página
...
$pdf=new PDF();
$title='Logs Baneos Gamer Chileno';
$pdf->SetTitle($title);
$pdf->SetAuthor('Pablo Riquelme');
$pdf->SetY(67);
$pdf->ImprimirArchivo(1,'Baneos','archivos/baneos.txt');
$pdf->Output('Baneos GCL.pdf','I');
?> 