...
?>	
	...
	<div class="container">
	  <div class="jumbotron text-center">
	    ...
	    <p>Último perdonazo hecho el 04 de Diciembre de 2014</p>
		</div>
	</div>
	<a href="http://gamerchileno.net/baneos-group/publico/"></a>
	<div class='table-responsive'><table style='font-size:12px;' class='table table-bordered'><tr>
	...
	<!--Scripts Google-->
		<!--AdSense-->
			...
			<ins class="adsbygoogle" style="display:inline-block;width:728px;height:90px" data-ad-client="ca-pub-7066797474773268" data-ad-slot="6268760430"></ins>
			<script>
