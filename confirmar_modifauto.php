...
$registros=mysql_query("update baneos
  ...
  $registros=mysql_query("update baneos
                       set dbanfecha='$fecha'
					   where numero='$_REQUEST[numero]' && dbanfecha!=$_REQUEST[fechadban]",$conexion) or
  die("Problemas en el select:".mysql_error());
  $registros=mysql_query("update baneos
  ...
  $registros=mysql_query("update sesionmodif
                       set Cantidaddbaneos=Cantidaddbaneos+1
					   where Usuario='$_SESSION[usuarioban]'",$conexion) or
  die("Problemas en el select:".mysql_error());
